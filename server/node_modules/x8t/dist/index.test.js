...
describe("x8tAsync and x8tSync functions", () => {
    ...
    it("x8tAsync: should return the result when a promise succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockPromiseSuccess = new Promise((resolve) => setTimeout(() => resolve("Promise Data Success"), 100));
        const { result, error } = yield (0, _1.x8tAsync)(mockPromiseSuccess);
        expect({ result, error }).toEqual({
    ...
    // Test promise error
    it("x8tAsync: should return the error when a promise fails", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockPromiseFailure = new Promise((_, reject) => setTimeout(() => reject(new Error("Promise Error!")), 100));
        const { result, error } = yield (0, _1.x8tAsync)(mockPromiseFailure);
        expect({ result, error }).toEqual({
            result: null,
